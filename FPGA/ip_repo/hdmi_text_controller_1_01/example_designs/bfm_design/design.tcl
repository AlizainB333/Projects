proc create_ipi_design { offsetfile design_name } {
	...
	set hdmi_text_controller_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:hdmi_text_controller:1.01 hdmi_text_controller_0]
...
set_property -name {xsim.simulate.runtime} -value {100ms} -objects [get_filesets sim_1]
	...
	set offset_file "${bd_path}/hdmi_text_controller_v1_01_tb_include.svh"
	set fp [open $offset_file "w"]
	puts $fp "`ifndef hdmi_text_controller_v1_01_tb_include_vh_"
	puts $fp "`define hdmi_text_controller_v1_01_tb_include_vh_\n"
...
set ip_path [file dirname [file normalize [get_property XML_FILE_NAME [ipx::get_cores xilinx.com:user:hdmi_text_controller:1.01]]]]
set test_bench_file ${ip_path}/example_designs/bfm_design/hdmi_text_controller_v1_01_tb.sv
...
for { set i 1 } { 1 } { incr i } {
	set design_name "hdmi_text_controller_v1_01_bfm_${i}"
...
remove_files -quiet -fileset sim_1 hdmi_text_controller_v1_01_tb_include.vh
import_files -fileset sim_1 -norecurse -force $interface_address_vh_file
set_property top hdmi_text_controller_v1_01_tb [get_filesets sim_1]
